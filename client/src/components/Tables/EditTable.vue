                ...
                <div class="col-md-12">
                    ...
                    <form v-on:submit.prevent="editTable">
                       <div class="form-group">
                        ...
                        <input type="text" class="form-control" v-model="table.tablenum" placeholder="Enter your number"/>
                      </div>
                      <div class="form-group">
                        <label >จำนวนที่นั่ง</label>
                        <input type="text" class="form-control" v-model="table.poeple" placeholder="Enter your number"/>
                      </div>
                      <div class="form-group">
                        <label >จำนวนเตา</label>
                        <input type="text" class="form-control" v-model="table.stove" placeholder="Enter your number"/>
                      </div>
...
export default {
  ...
  methods: {
    async editTable() {
      try {
        await TableService.put(this.table);
        this.$router.push({
          name: "tables",
        });
      } catch (err) {
